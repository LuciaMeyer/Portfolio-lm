...
export const AboutSection = () => {
  ...
  return (
    <section id='about' className='flex-1 pt-6 md:pt-20 pb-20 relative overflow-hidden'
    >
      ...
      <div className='h-full md:w-1/2 flex flex-col md:flex-row md:justify-around mx-10 md:pr-10 md:items-center pb-20'>
        ...
        <div className='md:hidden flex justify-center'>
          <Image width='350' height='350' src={images[currentImageIndex]} alt='img' priority />
        </div>
      </div>
    </section>
  );
