...
const projects = [
  {
    name: "let's GO",
    description:
      "e-commerce desarrollado por nuestro equipo como Proyecto Final de carrera en el Bootcamp de Henry, mediante trabajo colaborativo y metodología Scrum. Temática elegida: alquiler temporal de bicicletas, accesorios y packs de aventuras según calendario y stock disponible. Perfiles de usuario y administrador completo, interacción a través de posteos de experiencias. Valor agregado del negocio: fomentar la movilidad sustentable para el cuidado del medio ambiente y la salúd.",
    image: img.let,
