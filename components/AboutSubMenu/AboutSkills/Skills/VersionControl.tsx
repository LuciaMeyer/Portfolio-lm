...
export const VersionControl = () => {
    return (
        ...
        >
            ...
            <p className='mt-10'>
                Git es un sistema de control de versiones distribuido que permite rastrear cambios en archivos y colaborar en proyectos de software. GitHub es una plataforma en línea que utiliza Git para alojar, gestionar y compartir repositorios de código, facilitando la colaboración y el seguimiento de proyectos.
            </p>
        </motion.div>
    );
};
