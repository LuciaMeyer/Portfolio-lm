...
export const DataBase = () => {
  return (
    ...
    >
      ...
      <p className='mt-10'>
        PostgreSQL es un sistema de gestión de bases de datos relacional de código abierto que se destaca por su robustez y capacidad para gestionar datos estructurados y no estructurados. Sequelize es un ORM (Mapeador Objeto-Relacional) para NodeJS que simplifica la interacción con bases de datos SQL. Permite a los desarrolladores trabajar de manera más sencilla y eficiente utilizando JavaScript en lugar de SQL.
      </p>
    </motion.div>
  );
};
